...
@ccclass
export default class HozMainUI extends cc.Component {
    @property({
        type: cc.Node,
        displayName: '横屏节点 left'
    })
    left: cc.Node = null;

    @property({
        type: cc.Node,
        displayName: '竖屏节点 right'
    })
    right: cc.Node = null;
    ...
    public initData(): void {
        this.boardBg = this.left.getChildByName('boardBg');
        this.StreamRoot = this.boardBg.getChildByName('StreamRoot');
        this.Board = this.boardBg.getChildByName('Board');
        this.vecFinger = this.boardBg.getChildByName('hozFinger');
        this.vecWaring = this.node.getChildByName('hozWaring');
        this.EncouragingWord = this.left.getChildByName('EncouragingWord');
 ...
 */
  ...
  */
    ...
    private btnAnim(): void {
        const btnDown: cc.Node = this.right.getChildByName('btnDown');
